...
router.post('/orders-of-delivered', auth, catchErrors(adminController.ordersOfPay));
...
router.post('/visible-brand', auth, catchErrors(adminController.VisibleBrand));
router.post('/visible-category', auth, catchErrors(adminController.VisibleCategory));
...
router.post('/delete-spec',auth,catchErrors(adminController.DeleteSpec));
router.post('/delete-product-from-event',auth,catchErrors(adminController.DeleteEventProduct));
